...
assert(commit_msg:match("%[Ref 1%] %(User Review Required%)"), "Must have [Ref 1] for QA")
assert(commit_msg:match("Q: How should error correction"), "Must contain question")
assert(commit_msg:match("A: Reject frame"), "Must contain answer")
